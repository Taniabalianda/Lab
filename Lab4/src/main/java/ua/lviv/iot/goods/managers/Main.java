...
public class Main {
	public static void main(String[] args) {
		...
		List<GoodsForHome> sortedGoods = (new GoodsForHomeManager(goods).sortByLenght(true));
		System.out.println(sortedGoods);

		List<GoodsForHome> sortedGoods1 = (new GoodsForHomeManager(goods).sortByWidth(false));
